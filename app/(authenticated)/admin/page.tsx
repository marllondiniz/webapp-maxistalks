  ...
  return (
    <section className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="mt-1 text-xs text-[var(--brand-text-muted)] sm:text-sm">
          {t('subtitle')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
        <Link
          ...
          className="rounded-xl border border-white/10 bg-[var(--brand-surface)] p-4 shadow-lg transition hover:border-[var(--brand-primary)]/50 hover:bg-[var(--brand-surface)]/80 sm:p-5"
        >
          ...
          <span className="mt-3 inline-flex text-[10px] font-semibold uppercase tracking-wider text-[var(--brand-primary)] sm:mt-4 sm:text-xs">
            {t('viewDetails')} →
          </span>
        </Link>
        <Link
